...
<?php if ($is_front): ?> <!-- Front page Test-->
  ...
  <div class="mission_background_img <?php echo $diffuse_classes; ?>" style="background-image: url(<?php echo $mission_background; ?>);" ></div>
  <div class="overlay_container <?php echo $overlay_classes; ?>"></div>
