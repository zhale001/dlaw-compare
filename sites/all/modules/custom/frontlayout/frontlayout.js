...
Drupal.behaviors.frontlayout = {
  attach: function (context, settings) {
    $('#frontlayout', context).once(function () {
      // $(this).prepend('<div class="customize clearfix"><ul class="action-links1"><li><a href="#">' + Drupal.t('Rearrange blocks') + '</a></li><li><a href="/admin/structure/block/add?destination=admin/dashboard/frontlayout">Add1 custom block</a></li></ul><div class="canvas col-sm-12"></div></div>');
      ...
      $('<div class="add-block-holder"><a href="/admin/structure/block/add?destination=admin/dashboard/frontlayout" class="button"><span class="fa fa-plus"></span> Add custom block</a></div>').prependTo(_container);
